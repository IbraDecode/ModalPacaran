...
const BootScreen = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-night text-slate-100">
      <Kucing mood="loading" />
      <div className="glass-card rounded-3xl p-6 w-full max-w-md mt-4 text-center">
        <p className="text-lg font-semibold">ModalPacaran</p>
        <p className="text-sm text-white/70 mt-2">Lagi siapin ruangan buat kalian berdua.</p>
